...
export const prefixSchema = Schema.string()
    .case("lower")
    .hex()
    .min(4)
    .max(64)
...
export const pubkeySchema = Schema.string()
    .case("lower")
    .hex()
    .length(64)
    .label("pubkey");
...
export const signatureSchema = Schema.string()
    .case("lower")
    .hex()
    .length(128)
    .label("sig");

export const subscriptionSchema = Schema.string()
    .min(1)
...
export const createdAtSchema = Schema.number()
    .min(0)
    .multiple(1)
    .custom(seconds);
